...
@section('page-breadcrumb', 'Admin · Data Siswa · Tambah Baru')
...
<div class="page-header mb-4">
    <div>
        <h1 class="page-header-title">
            <i class="bi bi-person-plus-fill me-2" style="color:var(--clr-primary)"></i>Tambah Siswa Baru
        </h1>
        <p class="page-header-sub">Isi formulir di bawah untuk mendaftarkan siswa dan akun loginnya.</p>
    </div>
...
<form action="{{ route('admin.siswas.store') }}" method="POST" id="formTambahSiswa" novalidate>
    @csrf
    ...
    <div class="d-flex align-items-center justify-content-end gap-3 mt-4">
        ...
        <button type="submit" class="btn-primary d-flex align-items-center gap-2 px-4 py-2" style="border:none;border-radius:.75rem;cursor:pointer;font-weight:600;">
            <i class="bi bi-check2-circle"></i> Simpan Siswa
        </button>
    </div>
