...
@section('page-breadcrumb', 'Admin · Data Guru · Tambah Baru')
...
<div class="page-header mb-4">
    <div>
        <h1 class="page-header-title">
            <i class="bi bi-person-plus-fill me-2" style="color:var(--clr-primary)"></i>Tambah Guru Baru
        </h1>
        <p class="page-header-sub">Isi formulir di bawah untuk mendaftarkan guru dan akun loginnya.</p>
    </div>
...
<form action="{{ route('admin.guru.store') }}" method="POST" id="formTambahGuru" novalidate>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="kelas_mengajar[]" value="{{ $kelas }}" id="kelas_{{ $kelas }}" {{ is_array(old('kelas_mengajar')) && in_array($kelas, old('kelas_mengajar')) ? 'checked' : '' }}>
    ...
    <div class="d-flex align-items-center justify-content-end gap-3 mt-4">
        ...
        <button type="submit" class="btn-primary d-flex align-items-center gap-2 px-4 py-2"
            ...
            <i class="bi bi-check2-circle"></i> Simpan Guru
        </button>
    </div>
...
<script>
    ...
    // Run on initial load if mapel is already selected (e.g. old input)
